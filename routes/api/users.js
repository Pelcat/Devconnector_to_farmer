...
// allows to bring in mysecret ID
...
router.post('/', [
    ...
    async(req, res) => {
        ...
        const { name, email, password, mobile, street, suburb, postcode } = req.body;
        ...
        try {
            ...
            // config defined above allows to get secret
            jwt.sign(
                payload,
                config.get('jwtSecret'), { expiresIn: 360000 },
                (err, token) => {
